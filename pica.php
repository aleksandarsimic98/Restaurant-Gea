...
<div class="predjelo">
    ...
    <h1 class="naslovpre"> <b><i> Pića</b></i></h1>
</div>

<h1 class="naslovpred"> <b> <i> Ovde mozete naručiti Piće <br> Uvek sveže, uvek blizu</b></i></h1>

<?php
include_once("connection.php");       //connection to the DB
  
$prvopredjelo= "SELECT * FROM ponuda WHERE id=20";  
...
$trecepredjelo= "SELECT * FROM ponuda WHERE id=21";
...
$cetvrtopredjelo= "SELECT * FROM ponuda WHERE id=22";
...
$petopredjelo= "SELECT * FROM ponuda WHERE id=23";
...
$sestopredjelo= "SELECT * FROM ponuda WHERE id=26";
...
$sedmopredjelo= "SELECT * FROM ponuda WHERE id=27";
...
$osmopredjelo= "SELECT * FROM ponuda WHERE id=28";
