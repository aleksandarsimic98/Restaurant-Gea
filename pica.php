...
$prvopredjelo= "SELECT * FROM ponuda WHERE id=17";  
$rezultatprvopredejlo= mysqli_query($konekcija, $prvopredjelo);            //1. card info from DB 
$rezultatprvopredejloo=mysqli_fetch_assoc($rezultatprvopredejlo);   /////////////////////////////////////////////////

$drugopredjelo= "SELECT * FROM ponuda WHERE id=18";
$rezultatdrugopredejlo= mysqli_query($konekcija, $drugopredjelo);         //2. card info from DB
$rezultatdrugopredejloo=mysqli_fetch_assoc($rezultatdrugopredejlo);  ////////////////////////////////////////////////

$trecepredjelo= "SELECT * FROM ponuda WHERE id=19";
$rezultattrecepredejlo= mysqli_query($konekcija, $trecepredjelo);         //3. card info from DB
$rezultattrecepredejloo=mysqli_fetch_assoc($rezultattrecepredejlo); ////////////////////////////////////////////////

$cetvrtopredjelo= "SELECT * FROM ponuda WHERE id=20";
$rezultatcetvrtopredejlo= mysqli_query($konekcija, $cetvrtopredjelo);    //4. card info from DB
$rezultatcetvrtopredejloo=mysqli_fetch_assoc($rezultatcetvrtopredejlo);  ////////////////////////////////////////////////

$petopredjelo= "SELECT * FROM ponuda WHERE id=21";
$rezultatpetopredejlo= mysqli_query($konekcija, $petopredjelo);          //5. card info from DB
$rezultatpetopredejloo=mysqli_fetch_assoc($rezultatpetopredejlo); ////////////////////////////////////////////////

$sestopredjelo= "SELECT * FROM ponuda WHERE id=22";
$rezultatsestopredejlo= mysqli_query($konekcija, $sestopredjelo);          //6. card info from DB
$rezultatsestopredejloo=mysqli_fetch_assoc($rezultatsestopredejlo);  ////////////////////////////////////////////////

$sedmopredjelo= "SELECT * FROM ponuda WHERE id=23";
$rezultatsedmopredejlo= mysqli_query($konekcija, $sedmopredjelo);          //7. card info from DB
$rezultatsedmopredejloo=mysqli_fetch_assoc($rezultatsedmopredejlo);  ////////////////////////////////////////////////

$osmopredjelo= "SELECT * FROM ponuda WHERE id=24";
$rezultatosmopredejlo= mysqli_query($konekcija, $osmopredjelo);          //8. card info from DB
...
function prvakartica(){
  ...
  localStorage.setItem('nazivprviiii', nazivprvi);
  let cenaprvi = "<?php echo $rezultatprvopredejloo['cena']?>" 
  console.log(cenaprvi);
  localStorage.setItem('cenaprviiii', cenaprvi);            //1. card 
...
function drugakartica(){
  ...
  localStorage.setItem('nazivdrugiiii', nazivdrugi);
  let cenadrugi = "<?php echo $rezultatdrugopredejloo['cena']?>" 
  console.log(cenadrugi);
  localStorage.setItem('cenadrugiiii', cenadrugi);            //2. card 
...
function trecakartica(){
  ...
  localStorage.setItem('nazivtreciiii', nazivtreci);
  let cenatreci = "<?php echo $rezultattrecepredejloo['cena']?>" 
  console.log(cenatreci);
  localStorage.setItem('cenatreciiii', cenatreci);            //3. card 
...
function cetvrtakartica(){
  ...
  localStorage.setItem('nazivcetvrtiiii', nazivcetvrti);
  let cenacetvrti = "<?php echo $rezultatcetvrtopredejloo['cena']?>" 
  console.log(cenacetvrti);
  localStorage.setItem('cenacetvrtiiii', cenacetvrti);            //4. card 
...
function petakartica(){
  ...
  localStorage.setItem('nazivpetiiii', nazivpeti);
  let cenapeti = "<?php echo $rezultatpetopredejloo['cena']?>" 
  console.log(cenapeti);
  localStorage.setItem('cenapetiiii', cenapeti);            //5. card
...
function sestakartica(){
  ...
  localStorage.setItem('nazivsestiiii', nazivsesti);
  let cenasesti = "<?php echo $rezultatsestopredejloo['cena']?>" 
  console.log(cenasesti);
  localStorage.setItem('cenasestiiii', cenasesti);            //6. card 
...
function sedmakartica(){
  ...
  localStorage.setItem('nazivsedmiiii', nazivsedmi);
  let cenasedmi = "<?php echo $rezultatsedmopredejloo['cena']?>" 
  console.log(cenasedmi);
  localStorage.setItem('cenasedmiiii', cenasedmi);            //7. card 
...
function osmakartica(){
  ...
  localStorage.setItem('nazivosmiiii', nazivosmi);
  let cenaosmi = "<?php echo $rezultatosmopredejloo['cena']?>" 
  console.log(cenaosmi);
  localStorage.setItem('cenaosmiiii', cenaosmi);            //8. card 
