...
<?php
  ...
  $first_card= "SELECT * FROM products WHERE id=9";  
  ...
  $second_card= "SELECT * FROM products WHERE id=10";  
  ...
  $third_card= "SELECT * FROM products WHERE id=11";  
  ...
  $fourth_card= "SELECT * FROM products WHERE id=12";  
  ...
  $fifth_card= "SELECT * FROM products WHERE id=13";  
  ...
  $sixth_card= "SELECT * FROM products WHERE id=14";  
  ...
  $seventh_card= "SELECT * FROM products WHERE id=15";  
  ...
  $eighth_card= "SELECT * FROM products WHERE id=16";  
...
<div class="cards_div">
  <div class="container text-center">
    <div class="row" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_first_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_second_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  .  $final_third_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_fourth_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
    ...
    <div class="row" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_fifth_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_sixth_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  .  $final_seventh_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_eighth_card['image'] ." ' class='card-img-top' alt='main dishes card'> " ?>
          <div class="card-body">
...
<script>
  ...
  localStorage.setItem('nazivprviii', first_card_name);
  let first_card_price = "<?php echo $final_first_card['price']?>" 
  localStorage.setItem('cenaprviii', first_card_price);            //1. card 
...
function second_card(){
  ...
  localStorage.setItem('nazivdrugiii', second_card_name);
  let second_card_price = "<?php echo $final_second_card['price']?>" 
  localStorage.setItem('cenadrugiii', second_card_price);            //2. card 
...
function third_card(){
  ...
  localStorage.setItem('nazivtreciii', third_card_name);
  let third_card_price = "<?php echo $final_third_card['price']?>" 
  localStorage.setItem('cenatreciii', third_card_price);            //3. card 
...
function fourth_card(){
  ...
  localStorage.setItem('nazivcetvrtiii', fourth_card_name);
  let fourth_card_price = "<?php echo $final_first_card['price']?>" 
  localStorage.setItem('cenacetvrtiii', fourth_card_price);            //4. card 
...
function fifth_card(){
  ...
  localStorage.setItem('nazivpetiii', fifth_card_name);
  let fifth_card_price = "<?php echo $final_fifth_card['price']?>" 
  localStorage.setItem('cenapetiii', fifth_card_price);            //5. card
...
function sixth_card(){
  ...
  localStorage.setItem('nazivsestiii', sixth_card_name);
  let sixth_card_price = "<?php echo $final_sixth_card['price']?>" 
  localStorage.setItem('cenasestiii', sixth_card_price);            //6. card 
...
function seventh_card(){
  ...
  localStorage.setItem('nazivsedmiii', seventh_card_name);
  let seventh_card_price = "<?php echo $final_seventh_card['price']?>" 
  localStorage.setItem('cenasedmiii', seventh_card_price);            //7. card 
...
function eighth_card(){
  ...
  localStorage.setItem('nazivosmiii', eighth_card_name);
  let eighth_card_price = "<?php echo $final_eighth_card['price']?>" 
  localStorage.setItem('cenaosmiii', eighth_card_price);            //8. card 
