...
include_once("connection.php");       //connection to the DB
  ...
  $second_card= "SELECT * FROM products WHERE id=2";  
  ...
  $third_card= "SELECT * FROM products WHERE id=3";  
  ...
  $fourth_card= "SELECT * FROM products WHERE id=4";  
  ...
  $fifth_card= "SELECT * FROM products WHERE id=5";  
  ...
  $sixth_card= "SELECT * FROM products WHERE id=6";  
  ...
  $seventh_card= "SELECT * FROM products WHERE id=7";  
  ...
  $eighth_card= "SELECT * FROM products WHERE id=8";  
...
<div class="cards_div">
  <div class="container text-center">
    <div class="row" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_first_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_second_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  .  $final_third_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_fourth_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
    ...
    <div class="row" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_fifth_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_sixth_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  .  $final_seventh_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <?php echo " <img src='uploads/"  . $final_eighth_card['image'] ." ' class='card-img-top' alt='Appetizers Card'> " ?>
          <div class="card-body">
...
<script>
 function first_card(){
  ...
  localStorage.setItem('nazivprvii', first_card_name);
  let first_card_price = "<?php echo $final_first_card['price']?>" 
  localStorage.setItem('cenaprvii', first_card_price);            //1. card 
...
function second_card(){
  ...
  localStorage.setItem('nazivdrugii', second_card_name);
  let second_card_price = "<?php echo $final_second_card['price']?>" 
  localStorage.setItem('cenadrugii', second_card_price);            //2. card 
...
function third_card(){
  ...
  localStorage.setItem('nazivtrecii', third_card_name);
  let third_card_price = "<?php echo $final_third_card['price']?>" 
  localStorage.setItem('cenatrecii', third_card_price);            //3. card 
...
function fourth_card(){
  ...
  localStorage.setItem('nazivcetvrtii', fourth_card_name);
  let fourth_card_price = "<?php echo $final_first_card['price']?>" 
  localStorage.setItem('cenacetvrtii', fourth_card_price);            //4. card 
...
function fifth_card(){
  ...
  localStorage.setItem('nazivpetii', fifth_card_name);
  let fifth_card_price = "<?php echo $final_fifth_card['price']?>" 
  localStorage.setItem('cenapetii', fifth_card_price);            //5. card
...
function sixth_card(){
  ...
  localStorage.setItem('nazivsestii', sixth_card_name);
  let sixth_card_price = "<?php echo $final_sixth_card['price']?>" 
  localStorage.setItem('cenasestii', sixth_card_price);            //6. card 
...
function seventh_card(){
  ...
  localStorage.setItem('nazivsedmii', seventh_card_name);
  let seventh_card_price = "<?php echo $final_seventh_card['price']?>" 
  localStorage.setItem('cenasedmii', seventh_card_price);            //7. card 
...
function eighth_card(){
  ...
  localStorage.setItem('nazivosmii', eighth_card_name);
  let eighth_card_price = "<?php echo $final_eighth_card['price']?>" 
  localStorage.setItem('cenaosmii', eighth_card_price);            //8. card 
